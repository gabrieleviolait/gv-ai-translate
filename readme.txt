...
== Funzioni ==
* Shortcode [traduttore_translate] (alias [gv_translate])
...
2. Vai in Impostazioni > Traduttore.
...
6. Inserisci [traduttore_translate] (o il legacy [gv_translate]) dove vuoi il selettore oppure usa il floating.
...
== Credits ==
- Autore: Gabriele Viola — https://www.gabrieleviola.it
- Contribuzioni e testing: community

== Licenza ==
Questo plugin è rilasciato sotto GPLv2 o successiva. Vedi il file LICENSE.txt incluso per il testo completo della licenza.
